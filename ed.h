/* $Header: /home/hyperion/mu/christos/src/sys/tcsh-5.20/RCS/ed.h,v 1.12 1991/03/05 20:17:51 christos Exp $ */
/*
...
#define CC_FATAL		101 /* fatal error: inconsistant, must reset */
#define	CC_NORM			0
#define	CC_NEWLINE		1
#define	CC_EOF			2
...
EXTERN int prefixlen;		/* length of {up,down} history-search string */
...
EXTERN int CursorV,		/* real cursor vertical (line) */
    ...
    TermV, 	/* number of real screen lines (sizeof(DisplayBuf) / width */
    TermH;			/* screen width */
