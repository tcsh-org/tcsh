/* $Header: /home/hyperion/mu/christos/src/sys/tcsh-5.20/RCS/tw.spell.c,v 1.6 1990/11/25 10:13:49 christos Exp $ */
/*
...
#ifndef lint
static char *rcsid = "$Id: tw.spell.c,v 1.6 1990/11/25 10:13:49 christos Exp $";
#endif 
#include "sh.h"
#include "tw.h"
...
int oldsize, looking_for_cmd;
{
	...
	*p = '\0';		/* terminate it */
	...
	/* Don't tell t_search we're looking for cmd if no '/' in the name
	   so far but there are later - or it will look for *all* commands */
 ...
 * and adapted somewhat to corispond better to psychological reality.
