/* $Header: /home/hyperion/mu/christos/src/sys/tcsh-5.20/RCS/sh.parse.c,v 1.2 1990/11/25 10:12:59 christos Exp $ */
/*
...
#endif
#ifndef lint
static char *rcsid = "$Id: sh.parse.c,v 1.2 1990/11/25 10:12:59 christos Exp $";
#endif
...
again:
	...
	if (n < 0)
		n = 0;
	t = (struct command *) calloc(1, sizeof (*t));
	av = (Char **) calloc((size_t) (n + 1), sizeof (Char **));
	t->t_dcom = av;
	n = 0;
	if (p2->word[0] == ')')
		t->t_dflg = F_NOFORK;
